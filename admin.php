				...
				<div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="navbarSupportedContent">
				      ...
				      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
				        ...
				        <li class="nav-item">
				          <a class="nav-link " aria-current="page" href="index.php">Book_Shelf</a>
				        </li>
			...
			<form action="search.php"
				...
				<div class="input-group my-5">
  				<input type="text" 
  						class="form-control" 
  						name="key"
  						placeholder="Search Book..." aria-label="Search Book..." aria-describedby="basic-addon2">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="php/delete-category.php?id=<?=$category['id']?>" class="btn btn-danger">Delet</a>
					</tr>
					<?php } ?>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="php/delete-author.php?id=<?=$author['id']?> " class="btn btn-danger">Delet</a>
					</tr>
					<?php } ?>
